...
<%--                        </li>--%>
    ...
    <%--                </div>--%>
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-center mb-4" style="margin-top: 30px;">
                        <h1 class="h3 mb-0 text-gray-800"></h1>
                        <a href="#" id="prev_btn" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Prev</a>
                    </div>
                    <div class="d-sm-flex align-items-center justify-content-center mb-4">
                        <h1 class="h3 mb-0 text-gray-800"></h1>
                        <a href="#" id="next_btn" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Next</a>
                    </div>
